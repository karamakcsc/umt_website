frappe.pages['umt_inquiry'].on_page_load = function(wrapper) {
...
/* Floating Contact Us Button */
	...
	function submitToErpnext() {
		...
		frappe.call({
			method: 'umt_website.umt_website.functions.umt.inquiry_form',
			args: { data: formData },
			callback: function(response) {
				if (response.message) {
					frappe.msgprint('Inquiry Sent Successfully!');
